...
public class BoundingBox {
    ...
    /**
     * The upper left corner point of this bounding box. Is null only when this
     * bounding box is
     * empty.
     */
    ...
    /**
     * Constructs a (non-empty) bounding box with the given upper left `corner`,
     * `width` and
    ...
    /**
     * Returns the upper left corner this bounding box, or returns null if this
    ...
    /**
     * Returns the area of this bounding box (in squared units of the coordinate
     * system).
     */
    public double area() {
        return width * height;
    ...
    /**
     * Returns `true` if this bounding box is empty, so contains no points,
     * otherwise returns
     * `false`.
     */
    ...
    /**
     * Returns whether the given point `p` is contained within this bounding box,
     * either in its
    ...
    /**
     * Returns whether every point of the given bounding box `b` is contained within
     * this bounding
     * box.
     */
    ...
    /**
     * Returns the intersection of this bounding box with the given bounding box
     * `b`.
     */
    ...
    /**
     * Returns whether this BoundingBox is equal to another, which is true when they
     * have the same
    ...
    // Note: Since we overrode `equals()` we should also override `hashCode()`.
    // We'll discuss this
    // later in the course.
}
